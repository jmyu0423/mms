...
const Management = ({ }) => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { field: 'count', headerName: '건', flex: 2, cellStyle: { textAlign: "center" } },
    { field: 'piece', headerName: '점', flex: 2, cellStyle: { textAlign: "center" } },
    ...
    {
      field: 'image', headerName: '이미지', flex: 4, cellStyle: { textAlign: "center" },
  ...
  const updateRow = (obj) => {
    ...
    // Object.assign(newData, { addr: obj.addr, addrDetail: obj.addrDetail, comment: obj.comment, fullAddr: obj.addr + " " + obj.addrDetail });
